...
def demo_one_line_progress_meter():
    ...
    for i in range(10000):
        if not sg.OneLineProgressMeter('My 1-line progress meter', i+1, 1000, 'meter key','MY MESSAGE1', 'MY MESSAGE 2', orientation='h', bar_color=('white', 'red')):
            print('Hit the break')
            break
    for i in range(10000):
        if not sg.OneLineProgressMeter('My 1-line progress meter', i+1, 1000, 'meter key', 'MY MESSAGE1', 'MY MESSAGE 2',orientation='v' ):
            print('Hit the break')
            break
